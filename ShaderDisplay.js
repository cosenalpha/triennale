...
//il val è l'immagine in b/n
//aggiungere uniform per immagine scritta a riga 45 (252 nel reaction diffusion)
//moltiplicare i due val 
...
/*  
  void main() {
    float val = texture2D(tex, gl_FragCoord.xy * wh_rcp).r;
    float val2 = texture2D(title, gl_FragCoord.xy * wh_rcp).r;
    gl_FragColor = vec4(vec3(val2), 1.0);
  }
*/